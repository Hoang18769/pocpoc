...
// Add this import if clearSession is from a separate file
// import { clearSession } from "@/utils/auth" // adjust path as needed
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "var(--background)", color: "var(--foreground)" }}>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        {/* Tab Navigation */}
        <div className="flex space-x-1 mb-8 p-1 rounded-xl shadow-sm" style={{ backgroundColor: "var(--card)" }}>
          <button
            onClick={() => setActiveTab("users")}
            className={`flex-1 flex items-center justify-center px-6 py-3 rounded-lg font-medium transition-all duration-200 ${
              activeTab === "users" ? "shadow-md text-white" : "hover:bg-opacity-50"
            }`}
            style={
              activeTab === "users"
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center px-6 py-3 rounded-lg font-medium transition-all duration-200 ${
              activeTab === "posts" ? "shadow-md text-white" : "hover:bg-opacity-50"
            }`}
            style={
              activeTab === "posts"
                ? { backgroundColor: "var(--primary)", color: "var(--primary-foreground)" }
