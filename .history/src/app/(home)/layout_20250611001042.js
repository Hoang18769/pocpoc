...
export default function MainLayout({ children }) {
  ...
  const [activeChat, setActiveChat] = useState(null); // Thêm state này
      ...
      return (
        <div className="w-full h-full flex flex-col">
          <div className="flex items-center p-2 border-b">
            ...
            <h3 className="font-medium">Chat với {activeChat.target.givenName}</h3>
          </div>
          <Chatbox 
    ...
    <>
      ...
      <div className="h-screen flex flex-col">
        ...
        <div className="flex flex-1 pt-16 bg-[var(--background)] text-[var(--foreground)] transition-colors duration-500">
          ...
          {!hideRightSidebar && (
            <aside className="hidden md:flex w-[80px] lg:w-[400px] lg:max-w-[400px] h-[calc(100vh-64px)]">
  ...
  // ... (giữ nguyên phần AnimatePresence)
}
