...
export default function ChatLayout() {
  ...
  return (
    <div className="pt-16 flex h-[calc(100vh-64px)] bg-[var(--background)] text-[var(--foreground)] transition-colors duration-500 p-2 sm:p-4 gap-4">
      {/* Sidebar Chat List - 20% width on md and below */}
      <aside className="w-full sm:w-[15%] md:w-[15%] lg:w-[340px] rounded-2xl bg-[var(--card)] border border-[var(--border)] p-2 md:p-4 overflow-y-auto shadow-sm">
        <ChatList
          key={chatListKey}
      ...
      {/* Main Chat Box - 80% width on md and below */}
      <main className="flex-1 sm:w-[85%] rounded-2xl bg-[var(--card)] border border-[var(--border)] overflow-y-auto shadow-sm">
        {targetUser ? (
          <ChatBox
