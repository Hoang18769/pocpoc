...
export default function ChatLayout() {
  ...
  return (
    <div className="pt-16 flex h-[calc(100vh-64px)] bg-[var(--background)] text-[var(--foreground)] transition-colors duration-500 p-2 sm:p-4 gap-4">
      ...
      <aside className="w-full sm:w-[280px] md:w-[15%] lg:w-[340px] rounded-2xl bg-[var(--card)] border border-[var(--border)] p-2 md:p-4 overflow-y-auto shadow-sm">
        <ChatList
          key={chatListKey}
      ...
      <main className="flex-1 md:w-[80%] rounded-2xl bg-[var(--card)] border border-[var(--border)] overflow-y-auto shadow-sm">
        {targetUser ? (
          <ChatBox
