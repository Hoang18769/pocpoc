    ...
    <>
      ...
      <div className="h-screen flex flex-col">
        ...
        <div className="flex flex-1 pt-16 bg-[var(--background)] text-[var(--foreground)] transition-colors duration-500">
          ...
          {/* Right Sidebar */}
          {!hideRightSidebar && (
            <aside className=" border relative p-8 hidden md:flex flex-col justify-center items-center w-[80px] lg:w-[400px] lg:max-w-[400px] h-[calc(100vh-64px)] items-end justify-center">
              <div className="absolute top-0">
                <NotificationList/>
              </div>
              <div className=" absolute bottom-0">
                <Chatbox className="border"/>
              </div>
            </aside>
          )}
        </div>
