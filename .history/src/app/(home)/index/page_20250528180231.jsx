...
const postSample = {
  user: {
    name: "Jane Doe", 
     avatar: avt.src, // hoặc để trống sẽ dùng ảnh `avt` mặc định
  },
  time: "2 hours ago",
  content: "Exploring the mountains today! 🏔️ The view is breathtaking and I feel so alive.",
  image: "https://pngdownload.io/wp-content/uploads/2025/04/Tung-Tung-Tung-Sahur-TikTok-Meme-Character-Transparent.webp", // bạn có thể thay bằng URL thực tế
  likes: 132,
  latestComment: {
    user: "johnsmith",
...
export default function HomePage() {
  return (
      <main className="p-6 space-y-6 flex flex-col items-center">
       <PostCard key={Math.random()} post={postSample} />
      <PostCard key={2} post={postSample1} />
      <PostCard key={4} post={postSample} />
    </main>
  )
}
