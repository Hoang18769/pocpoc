  ...
  const layoutContent = (
    <div className="h-screen flex flex-col">
      ...
      <div className="flex flex-1 pt-16 bg-[var(--background)] text-[var(--foreground)] transition-colors duration-500">
        ...
        {/* Sidebar trái */}
        <aside className="sm:hidden md:w-[80px] h-[calc(100vh-64px)] overflow-y-auto">
          <Sidebar />
        </aside>
        ...
        {/* Nút chat bên phải */}
        <aside className="hidden md:flex md:w-[300px] h-[calc(100vh-64px)] items-end justify-center">
