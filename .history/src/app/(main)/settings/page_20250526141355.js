  ...
  return (
    <div className="flex min-h-screen w-full bg-[var(--background)] text-[var(--foreground)]">
      ...
      <aside className="w-[280px] border-r border-[var(--border)] p-6 space-y-6">
        <h2 className="text-sm text-[var(--muted-foreground)] font-semibold">Demo</h2>
        ...
        <div className="bg-[var(--card)] p-6 rounded-lg shadow-md space-y-6">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <div className="text-[var(--muted-foreground)]">Huỳnh Huy Hoàng</div>
            </div>
          ...
          <div>
            <label className="block text-sm font-semibold mb-1">Giới thiệu về bạn</label>
            <input
              type="text"
