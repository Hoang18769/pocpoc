...
export default function SimpleTogglePage() {
  ...
  const components = [
    { id: "component-1", name: "Component 1", bgColor: "bg-blue-500" },
    { id: "component-2", name: "Component 2", bgColor: "bg-green-500" },
    { id: "component-3", name: "Component 3", bgColor: "bg-yellow-500" },
    { id: "component-4", name: "Component 4", bgColor: "bg-purple-500" },
    { id: "component-5", name: "Component 5", bgColor: "bg-pink-500" },
    { id: "component-6", name: "Component 6", bgColor: "bg-indigo-500" },
  ]
