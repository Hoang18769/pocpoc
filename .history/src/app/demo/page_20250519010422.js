...
>Open modal</Button>
      ...
      <Card elevation={2} className="border border-gray-200">Card with stronger shadow and border</Card>
      <Card elevation={3} style={{ maxWidth: 400, margin: "auto" }}>
        Card with inline style and bigger shadow
      </Card>
      </div>
      <div>
