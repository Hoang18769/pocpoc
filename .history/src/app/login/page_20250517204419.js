...
src={Connectimg}
        ...
        <div ref={formRef} className="w-full md:w-1/2 min-h-screen flex items-center justify-center p-6 bg-black">
          <div className="w-full max-w-md bg-card text-card-foreground rounded-xl p-8 shadow-md">
