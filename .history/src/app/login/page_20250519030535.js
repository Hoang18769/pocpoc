...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)] flex flex-col">
      {/* Header */}
      <header className="w-full p-6 flex justify-between items-center bg-[var(--background)]">
      ...
      <main className="flex-grow flex flex-col md:flex-row">
        {/* Left Side */}
        <div className="w-full md:w-1/2 h-screen md:h-auto relative flex items-center justify-center bg-[var(--muted)]">
          ...
          <div className="absolute bottom-10 left-0 right-0 flex justify-center md:hidden">
            <button
              ...
              className="flex items-center gap-2 bg-[var(--primary)] text-[var(--primary-foreground)] px-6 py-3 rounded-full shadow-lg hover:opacity-90 transition-opacity"
            >
              Go to sign in
        ...
        <div
          ref={formRef}
          className="w-full md:w-1/2 min-h-screen flex items-center justify-center p-6 bg-[var(--background)]"
        >
          <div
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-transparent border-b rounded-none px-0 py-1 focus:outline-none"
                  style={{
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-transparent border-b rounded-none px-0 pr-10 py-1 focus:outline-none"
                    style={{
                      borderColor: "var(--input)",
                      color: "var(--foreground)",
                    }}
              ...
              <button
                type="submit"
                className="w-full font-medium py-3 rounded-md transition-opacity"
                style={{
