...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      {/* Header */}
      <header className="fixed t-0  border w-full p-4 flex justify-between items-center bg-[var(--background)]">
      ...
      <main className="flex-grow flex flex-col md:flex-row">
        {/* Left Side */}
        <div className="border w-full md:w-1/2 h-screen flex items-center justify-center bg-muted">
          ...
          <div className="absolute overflow-hidden bottom-10 left-0 right-0 flex justify-center md:hidden">
            <button
