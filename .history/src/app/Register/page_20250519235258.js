  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="flex-grow flex flex-col md:flex-row">
        {/* Left Side */}
        <div className="border w-full md:w-1/2  flex items-center justify-center bg-muted">
        ...
        <div
          ref={formRef}
          className="w-full md:w-1/2  flex items-center justify-center p-6 bg-background"
        >
