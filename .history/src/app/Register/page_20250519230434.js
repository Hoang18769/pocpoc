...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      <header className="fixed top-0 border w-full p-4 flex justify-between items-center bg-[var(--background)] z-10">
      ...
      <main className="flex-grow flex flex-col md:flex-row pt-16">
        <div className="border w-full md:w-1/2 h-screen flex items-center justify-center bg-muted relative">
          <Image
            src={Connectimg}
            ...
            priority
          />
          <div className="absolute z-[0] bottom-10 left-0 right-0 flex justify-center md:hidden">
            <button
