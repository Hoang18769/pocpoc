...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      {/* Header */}
      <header className="fixed t-0 z-0 border w-full p-4 flex justify-between items-center bg-background">
      ...
      <main className="flex-grow flex flex-col md:flex-row">
        {/* Left Side */}
        <div className="border w-full md:w-1/2 h-screen relative flex items-center justify-center bg-muted">
