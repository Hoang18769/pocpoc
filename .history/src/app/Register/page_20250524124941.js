...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      {/* Main */}
      <main className="flex-grow h-screen md:h-auto md:flex md:flex-row overflow-hidden max-md:overflow-y-scroll max-md:snap-y max-md:snap-mandatory pt-14">
        {/* Left Side */}
        <div className="w-full h-screen md:h-auto md:w-1/2 flex items-center justify-center bg-muted relative max-md:snap-start">
          <Image
            src={Connectimg}
        ...
        <div
          ref={formRef}
          className="w-full h-screen md:h-auto md:w-1/2 flex items-center justify-center p-6 bg-background max-md:snap-start"
        >
          <div
