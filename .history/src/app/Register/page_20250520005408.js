  ...
  return (
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="flex-grow flex flex-col md:flex-row">
        {/* Left Side */}
        <div className="relative border w-full md:w-1/2 h-screen md:h-screen flex flex-col justify-center items-center bg-muted">
          ...
          {/* Mobile button (luôn hiển thị ngay dưới ảnh) */}
