...
export default function AuthPage() {
  ...
  // Fixed redirect logic - redirect to dashboard instead of index
  useEffect(() => {
    if (!authLoading && isAuthenticated) {
      ...
      const targetPath = redirectPath || '/dashboard' // Default to dashboard, not index
        ...
        if (res.data.code === 200 && res.data.body.token) {
          ...
          if (loginSuccess) {
            ...
            setTimeout(() => {
              ...
              router.replace(redirectPath) // Use router.replace instead of window.location
            }, 500)
          } else {
