...
export default function MainLayout({ children }) {
  return (
    <div className="h-screen bg-[var(--background)] text-[var(--foreground)] flex flex-col">
      {/* Fixed Header */}
      <div className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-900 h-16">
        <Header />
      </div>
      ...
      <div className="flex flex-1 pt-16">
        {/* Sidebar - 10% */}
        <div className="md:w-[8%] sm:hidden md:block sticky top-16 h-[calc(100vh-64px)] overflow-y-auto">
          <Sidebar />
        </div>
