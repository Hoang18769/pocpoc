  ...
  return (
    <div className="h-screen bg-[var(--background)] text-[var(--foreground)] flex flex-col">
      ...
      <div className="flex flex-1 pt-16">
        {/* Sidebar - 10% */}
        <div className="w-1/5 sm:hidden border md:flex sticky top-16 h-[calc(100vh-64px)] overflow-y-auto">
          <Sidebar />
        </div>
        <div className="w-1/5 md:hidden border md:flex sticky top-16 h-[calc(100vh-64px)] overflow-y-auto">
          <Sidebar />
        </div>
