...
export default function MainLayout({ children }) {
  ...
  return (
    <div className="h-screen bg-[var(--background)] text-[var(--foreground)] flex flex-col">
      {/* Fixed Header */}
      <div className="fixed top-0 left-0 right-0 z-50 h-12 bg-white dark:bg-gray-900 ">
        <Header />
      </div>
      ...
      <div className="flex flex-1 pt-[64px]">
        {/* Sidebar - 10% */}
        <div className="border hidden md:flex md:w-[8%] sticky top-[64px] h-[calc(100vh-64px)] overflow-hidden">
          <Sidebar />
        </div>
