  ...
  return (
    <div className="h-screen bg-[var(--background)] text-[var(--foreground)] flex flex-col">
      ...
      <div className="flex flex-1 pt-16">
        {/* Sidebar - 10% */}
        <div className="border md:w-4/5 hidden md:flex md:w-[8%] sticky top-16 h-[calc(100vh-64px)] overflow-hidden">
          <Sidebar />
        </div>
        ...
        <aside className="hidden md:flex md:w-[30%] sticky top-16 h-[calc(100vh-64px)] overflow-hidden px-4">
