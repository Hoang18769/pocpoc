  ...
  return (
    <div className="h-screen bg-[var(--background)] text-[var(--foreground)] flex flex-col ">
      ...
      <div className="flex flex-1 pt-16">
        ...
        <aside className="hidden md:flex justify-end md:w-[30%] sticky top-16 h-[calc(100vh-64px)] overflow-hidden">
          <div className=" rounded-xl w-full h-full overflow-auto">
