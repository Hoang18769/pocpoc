...
export default function MainLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] text-[var(--foreground)]">
      <Header />
      <div className="flex flex-col md:flex-row t-0 b-0 absolute">
        {/* Sidebar - 10% */}
        <div className="hidden md:block md:w-[10%] p-2">
          <Sidebar />
        </div>
        ...
        <aside className="hidden md:block md:w-[30%] p-4">
          ...
          <div className="bg-gray-100 dark:bg-gray-800 rounded-xl p-4 h-full">
