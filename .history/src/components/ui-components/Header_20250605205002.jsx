...
export default function Header({ className = "" }) {
  ...
  const handleCreatePost = async () => {
    ...
    try {
      ...
      formData.append("content", "hihihaha");
      formData.append("privacy", "PRIVATE");

      // Fetch file từ public folder (Connect.jpg)
      const response = await fetch("/Connect.jpg");
      const blob = await response.blob();
      const file = new File([blob], "apple.jpg", { type: blob.type });
