  ...
  return (
    <div
      className={`border
        ...
        fixed bottom-0 left-0 right-0 h-14 p-2
        md:static md:w-full md:h-[calc(100vh-64px)] md:sticky md:top-[64px] md:items-start
    ...
    >
      <div
        className="bg-gray-100 dark:bg-gray-800 border
          text-[var(--foreground)]
          rounded-none md:rounded-full w-full p-2 md:p-4"
      >
        <nav className="flex flex-1 md:flex-col items-center justify-around md:justify-start md:space-y-10">
          {menuItems.map((item) => {
