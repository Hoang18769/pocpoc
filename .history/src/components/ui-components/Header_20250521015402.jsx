...
export default function Header({ className = "" }) {
  return (
    <header
      className={`w-full p-4 px-6 flex items-center justify-between bg-white dark:bg-black ${className}`}
    >
      ...
      <div className="w-1/3 flex justify-end space-x-2 items-center">
        <button
          ...
          className="w-12 h-12 bg-gray-200 dark:bg-gray-800 rounded-full flex items-center justify-center hover:bg-gray-300 dark:hover:bg-gray-700 transition relative"
        >
