  ...
  return (
    <div
      className={`
        ...
        flex  justify-around 
        md:static md:top-[64px] md:items-center md:h-full
        w-auto md:flex md:px-2 md:py-6
      `}
    >
      <nav className="bg-[var(--card)] p-4 rounded-xl flex flex-row md:flex-col items-center justify-around md:justify-center md:space-y-6 w-full md:w-full">
        {menuItems.map((item) => {
              ...
              className={`
                ...
                ${
                  activeItem === item.id
                    ...
                    : "text-white hover:text-black dark:hover:bg-white"
                }
              `}
            >
              <Icon
