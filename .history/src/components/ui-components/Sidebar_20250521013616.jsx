  ...
  return (
    <div
      className={`
        ...
        fixed bottom-0 h-14 w-full 
        md:sticky md:top-[64px] md:left-0 md:h-[calc(100vh-64px)] md:w-[8%]
        z-50
        border-t md:border-t-0 md:border-r
        bg-gray-100 dark:bg-gray-800
      `}
    >
      <nav className="flex w-full md:h-full md:flex-col items-center justify-around md:justify-between md:py-8">
        {menuItems.map((item) => {
