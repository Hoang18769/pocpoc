    ...
    <>
      <Modal isOpen={isOpen} onClose={onClose}>
        <div className="relative p-4">
          ...
          {/* Cấu trúc giống CreatePostForm */}
          {canEditFiles && media.length === 0 ? (
            // Upload area khi chưa có media
            <div
            ...
            // Layout với media - giống CreatePostForm
            ...
            // Form cho shared post hoặc không có media
          ...
          {/* Form cho trường hợp media.length === 0 và không có upload area */}
          {canEditFiles && media.length === 0 && (
