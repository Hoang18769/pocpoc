...
export default function ProfileHeader({ profileData, isOwnProfile = true, onProfileUpdate, onChatInitiate }) {
  ...
  const handleChatClick = () => {
    const targetUserId = profileData.username;
    ...
    const chatInfo = {
      type: "new", // hoặc bạn có thể thay đổi nếu muốn check xem đã có chat chưa
    };
    ...
    if (onChatInitiate) {
      onChatInitiate(chatInfo, userInfo);
    }
  };
