  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (
        ...
        promises.push(
          axios.patch(
            `${process.env.NEXT_PUBLIC_API_URL}/v1/auth/loginusers/update-name?givenName=${encodeURIComponent(formData.firstname)}&familyName=${encodeURIComponent(formData.lastname)}`
          ).then(() => {
