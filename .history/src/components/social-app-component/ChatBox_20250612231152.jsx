                ...
                <div className={clsx("flex items-start gap-2 max-w-[60%]", {
                  ...
                  <div className="relative">
                    ...
                    {isSelected && isSelf && !isEditing && (
                      <div className={clsx(
                        "absolute top-0 left-0 transform -translate-x-full -translate-y-1 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-1 z-10 min-w-[100px]"
                      )}>
                        <button
