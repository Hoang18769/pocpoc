          ...
          messages.map((msg, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Message Actions - Left side for self messages */}
                {isSelf && (
                  <div className="flex items-center opacity-0 group-hover:opacity-100 transition-opacity mt-1">
                    <button
                      onClick={() => handleMessageClick(msg)}
                      className="text-[var(--muted-foreground)] hover:text-[var(--foreground)] p-1 rounded-full hover:bg-[var(--muted)]"
                    >
                ...
                <div className="relative flex-1 max-w-[70%]">
                  <div
                    className={clsx(
                      "rounded-xl px-3 py-2 text-sm word-wrap break-words",
                      isSelf
                    ...
                    {isEditing ? (
                      <div className="flex items-center gap-2 min-w-0">
                        <input
                          ...
                          className="bg-transparent border-none outline-none text-white placeholder-blue-200 flex-1 min-w-0"
                  ...
                  {isSelected && isSelf && !isEditing && (
                    <div className={clsx(
                      ...
                      isSelf ? "-left-2 transform -translate-x-full" : "-right-2 transform translate-x-full"
                    )}>
                      <button
                ...
                {/* Message Actions - Right side for other user messages (if needed) */}
                {!isSelf && (
