...
export default function EditProfileModal({ profileData, onSave }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Gửi PUT request cập nhật thông tin
      ...
      setErrors(prev => ({
        ...prev,
        info: err.response?.data?.message || "Failed to update info",
      }))
    }

    // Gửi PATCH request cập nhật avatar nếu có thay đổi
    if (avatarFile) {
      try {
        ...
        setErrors(prev => ({
          ...prev,
          avatar: err.response?.data?.message || "Failed to update avatar",
        }))
      }
    }
