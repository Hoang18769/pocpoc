...
// Helper functions - Đơn giản hóa vì không cần cắt từ URL nữa
const getFilename = (msg) => {
  return msg.attachmentName || 'File đính kèm';
};
            ...
            >
              {msg.deleted ? (
                ...
                renderFileInfo(
                  ...
                  getFilename(msg) // Sử dụng getFilename mới
                )
              ) : msg.attachedFile ? (
                renderFileInfo(
                  msg.attachedFile.url, 
                  msg.attachedFile.contentType, 
                  msg.attachedFile.originalFilename || getFilename(msg), // Fallback nếu không có originalFilename
