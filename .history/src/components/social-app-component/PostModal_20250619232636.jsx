  ...
  return (
    <Modal isOpen={true} onClose={onClose}>
      <div className="flex flex-col md:flex-row w-full h-[90vh] bg-[var(--card)] text-[var(--card-foreground)] rounded-xl overflow-hidden">
        {/* Mobile Layout - Show content first */}
        ...
        <div className="hidden md:flex w-full h-full">
          {/* Media section */}
          <div
            className="relative w-3/5 bg-black overflow-hidden"
            onTouchStart={handleTouchStart}
            onTouchEnd={handleTouchEnd}
          >
            <AnimatePresence initial={false} custom={page.direction}>
          ...
          {/* Content section */}
          <div className="w-2/5 p-4 flex flex-col justify-between overflow-y-auto">
