...
export default function PostCard({ post, size = "default", className = "" }) {
  ...
  const padding = size === "compact" ? "p-2 sm:p-3" : size === "large" ? "p-4 sm:p-5" : "p-3 sm:p-4"
      ...
      {activeImageIndex !== null && (
        <Modal isOpen={true} onClose={closeModal}>
          ...
          >
            ...
            />
            <button
              className="absolute top-1/2 left-0 -translate-y-1/2 p-2 bg-black/50 hover:bg-black/70 text-white rounded-full"
            ...
            <button
              className="absolute top-1/2 right-0 -translate-y-1/2 p-2 bg-black/50 hover:bg-black/70 text-white rounded-full"
