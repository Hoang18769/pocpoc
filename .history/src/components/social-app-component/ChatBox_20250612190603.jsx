          ...
          messages.map((msg, index) => {
            ...
            return (
              ...
              >
                ...
                {isSelf && (
                  <div className="flex items-center opacity-0 group-hover:opacity-100 transition-opacity mt-1 flex-shrink-0">
                    <button
                ...
                {!isSelf && (
                  <div className="flex-shrink-0 w-6"></div> // Placeholder for symmetry
                )}
              </div>
            );
          })
