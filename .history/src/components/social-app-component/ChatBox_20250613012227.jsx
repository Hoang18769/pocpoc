...
export default function ChatBox({ chatId, targetUser, onBack }) {
  ...
  const handleSendFile = async () => {
    ...
    formData.append("sender", targetUser.username);
    formData.append("receiver", selectedFile);
    formData.append("chat", selectedFile);
    ...
    try {
      ...
      // Reset file selection sau khi gửi thành công
      handleCancelFile();
