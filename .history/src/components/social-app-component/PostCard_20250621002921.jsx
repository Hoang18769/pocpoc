        ...
        <div className="flex items-center gap-2 mb-3 cursor-pointer hover:underline" onClick={handleOriginalProfileClick}>
          ...
          <div>
            ...
            <p className="text-xs text-[var(--muted-foreground)]">
              {dayjs(post.originalPost.createdAt).fromNow()} {renderPrivacyIcon(post.privacy)}
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div>
            ...
            <p className={textSizes.time}>
              {dayjs(post.createdAt).fromNow()} {renderPrivacyIcon(post.originalPost.privacy)}
            </p>
