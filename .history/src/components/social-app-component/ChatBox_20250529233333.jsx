  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="flex items-center gap-3 bg-[var(--card)] text-[var(--foreground)] p-4 rounded-full shadow-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
      >
