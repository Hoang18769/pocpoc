// ... giữ nguyên import + helper như bạn gửi
...
export default function MessageItem({
  ...
  return (
    <>
      <div className={clsx("flex items-end gap-2 group", {
        "justify-end": isSelf,
        ...
        <div className={clsx("flex items-end gap-1 max-w-[80%]", {
          ...
          {/* Thời gian bên cạnh tin nhắn */}
          <div
            className={clsx("text-xs opacity-60 whitespace-nowrap", {
              "mr-1": isSelf,
              "ml-1": !isSelf,
            })}
          >
