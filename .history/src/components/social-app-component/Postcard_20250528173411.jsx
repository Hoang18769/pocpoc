...
export default function PostCard({ post, size = "default", className = "" }) {
  // isMobile khởi tạo null = chưa biết kích thước màn hình
  ...
  // Nếu chưa biết kích thước, render fallback UI đơn giản (hoặc loading)
  if (isMobile === null) {
    // Bạn có thể render null hoặc 1 skeleton loading component để tránh nhảy layout
    return null
  }

  // Hàm lấy kích thước avatar tùy vào isMobile và size
  const getAvatarSize = () => {
    return isMobile
