    ...
    <Card className={`flex flex-col ${padding} w-full ${className}`}>
      <div className={`flex items-center justify-between ${textSizes.spacing}`}>
        <div className="flex items-center gap-2">
          <Avatar src={post.author?.avatar} alt={post.author?.username} size={getAvatarSize()} />
          <div>
      ...
      {/* ImageView expects array of image URLs */}
      <ImageView images={post.files} onImageClick={handleImageClick} />
      ...
      {/* Nếu bạn muốn hiện comment gần nhất, hãy thêm xử lý riêng tại đây */}
