"use client" // Đánh dấu đây là component client nếu bạn dùng app router, không bắt buộc với pages router
...
export default function PostCard({ post, size = "default", className = "" }) {
  ...
  // Trước khi biết kích thước màn hình, render null hoặc skeleton nếu muốn
  if (!isMobile && isMobile !== false) return null
