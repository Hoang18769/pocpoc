            ...
            return (
              ...
              >
                ...
                <div className={clsx("flex items-start gap-2 max-w-[60%]", {
                  ...
                  {isSelf && (
                    <div className="flex items-center opacity-0 hover:bg-black group-hover:opacity-100 transition-opacity duration-200 mt-1 flex-shrink-0">
                      <button
                  ...
                  {isSelected && isSelf && !isEditing && (
                    <div className={clsx(
                      ...
                      "left-0 transform -translate-x-full -translate-y-1"
                    )}>
                      <button
                ...
                {/* Spacing for other user messages */}
                {!isSelf && (
