...
const handleChatClick = () => {
  ...
  if (existingChat) {
    selectChat(existingChat.id); // Truyền chatId để hiển thị cuộc trò chuyện
    return;
  }
  ...
  if (chatInfo?.chatId) {
    selectChat(chatInfo.chatId); // Nếu có chatId, truyền nó vào để hiển thị cuộc trò chuyện
    console.log(`Đang hiển thị chat ID: ${chatInfo.chatId}`);
  } else {
