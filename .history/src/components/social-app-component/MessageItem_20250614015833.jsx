...
const fullTime = (isoString) => dayjs(isoString).format("HH:mm · DD/MM/YYYY");
        ...
        <div className={clsx("flex items-start gap-2 max-w-[80%]", {
          ...
          <div className="relative">
            ...
            >
              ...
              <span
                className={clsx(
                  "block text-[10px] opacity-60 mt-1",
                  isSelf ? "text-[var(--primary-foreground)]" : "text-[var(--muted-foreground)]"
                )}
