...
export default function useChat(chatId) {
  ...
  useEffect(() => {
    if (!latestMessage || !chatId) {
      console.log("❌ Không có latestMessage hoặc chatId:", { latestMessage, chatId });
      return;
    }

    console.log("🔄 Processing latestMessage:", latestMessage);
    ...
    client.onConnect = () => {
      ...
      client.subscribe(`/chat/${chatId}`, (message) => {
        try {
          ...
          console.log("🎯 Setting latestMessage:", newMessage);
